...
import { ChangePassword, DashboardLayout, Sidebar, UserProfile, UserManagement, EnterpriseManagement, CreateEnterprise, DepartmentReports } from "../../components";
...
export const DepartmentDashboardScreen: React.FC = () => {
  ...
  const [activeView, setActiveView] = useState<"profile" | "change-password" | "user-management" | "enterprise-management" | "company-info" | "tnld-reports">("profile");
